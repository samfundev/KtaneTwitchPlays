...
public static class ComponentSolverFactory
{
	...
	static ComponentSolverFactory()
	{
		...
		ModComponentSolverInformation["MorseV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Moresmatics", helpText = "Turn the lights off with !{0} lights off. Turn the lights on with !{0} lights on. Tranmit the answer with !{0} transmit -..-", moduleScore = 12 };
		...
		ModComponentSolverInformation["PasswordComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Password", helpText = "!{0} cycle 3 [cycle through the letters in column 3] | !{0} world [try to submit a word]", manualCode = "Passwords", moduleScore = 2 };
		...
		ModComponentSolverInformation["PasswordsTranslated"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Password Translated", helpText = "!{0} cycle 3 [cycle through the letters in column 3] | !{0} world [try to submit a word]", moduleScore = 2 };
	    ...
	    ModComponentSolverInformation["Color Generator"] = new ModuleInformation { moduleDisplayName = "Color Generator", moduleScore = 6, helpText = "Submit a color using !{0} submit 123 123 123." };
		...
		ModComponentSolverInformation["Mastermind Simple"] = new ModuleInformation { moduleScore = 10, manualCode = "Mastermind", DoesTheRightThing = true };
		ModComponentSolverInformation["Mastermind Cruel"] = new ModuleInformation { moduleScore = 12, DoesTheRightThing = true };
