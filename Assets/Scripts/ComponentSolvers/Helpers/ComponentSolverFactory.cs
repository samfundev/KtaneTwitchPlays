...
public static class ComponentSolverFactory
{
    ...
    static ComponentSolverFactory()
    {
       ...
       //Hexi Modules
        ...
        ModComponentSolverInformation["KeypadV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "KeypadV2", moduleDisplayName = "Round Keypad", helpText = "Solve the module with !{0} press 2 4 6 7 8. Button 1 is the top most botton, and are numbered in clockwise order.", moduleScore = 6 };
        ...
        ModComponentSolverInformation["SimonV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "SimonV2", moduleDisplayName = "Simon States", helpText = "Enter the response with !{0} press B Y R G.", moduleScore = 8 };
        ...
        ModComponentSolverInformation["MazeV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "MazeV2", moduleDisplayName = "Plumbing", helpText = "Rotate the pipes with !{0} rotate A1 A1 B2 B3 C2 C3 C3. Check your work for leaks Kappa with !{0} submit. (Pipes rotate clockwise. Top left is A1, Bottom right is F6)", moduleScore = 20 };
        ModComponentSolverInformation["MorseV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "MorseV2", moduleDisplayName = "Moresmatics", helpText = "Turn the lights off with !{0} lights off. Turn the lights on with !{0} lights on. Tranmit the answer with !{0} transmit -..-", moduleScore = 12 };
        ModComponentSolverInformation["NeedyVentV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "NeedyVentV2", moduleDisplayName = "Needy Answering Questions", helpText = "Answer the question with !{0} Y or !{0} N.", manualCode = "Answering%20Questions" };
        ModComponentSolverInformation["NeedyKnobV2"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "NeedyKnobV2", moduleDisplayName = "Needy Rotary Phone", helpText = "Respond to the phone call with !{0} press 8 4 9.", manualCode = "Rotary%20Phone" };

        //Perky
        ModComponentSolverInformation["CrazyTalk"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "CrazyTalk", moduleDisplayName = "Crazy Talk", helpText = "Toggle the switch down and up with !{0} toggle 4 5. The order is down, then up.", moduleScore = 3 };
        ModComponentSolverInformation["CryptModule"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "CryptModule", moduleDisplayName = "Cryptography", helpText = "Solve the cryptography puzzle with !{0} press N B V T K.", moduleScore = 9 };
        ModComponentSolverInformation["ForeignExchangeRates"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "ForeignExchangeRates", moduleDisplayName = "Foreign Exchange Rates", helpText = "Solve the module with !{0} press ML. Positions are TL, TM, TR, ML, MM, MR, BL, BM, BR.", moduleScore = 6 };
        ModComponentSolverInformation["Listening"] = new ModuleInformation { builtIntoTwitchPlays = true, statusLightLeft = true, moduleID = "Listening", moduleDisplayName = "Listening", helpText = "Listen to the sound with !{0} press play. Enter the response with !{0} press $ & * * #.", moduleScore = 8 };
        ModComponentSolverInformation["OrientationCube"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "OrientationCube", moduleDisplayName = "Orientation Cube", helpText = "Move the cube with !{0} press cw l set.  The buttons are l, r, cw, ccw, set.", moduleScore = 6 };
        ModComponentSolverInformation["Probing"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "Probing", moduleDisplayName = "Probing", helpText = "Get the readings with !{0} cycle. Try a combination with !{0} connect 4 3.  Cycle reads 1&2, 1&3, 1&4, 1&5, 1&6.", moduleScore = 6 };
        ModComponentSolverInformation["TurnTheKey"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "TurnTheKey", moduleDisplayName = "Turn The Key", helpText = "Turn the key at specified time with !{0} turn 8:29", moduleScore = 6 };
        ModComponentSolverInformation["TurnTheKeyAdvanced"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "TurnTheKeyAdvanced", moduleDisplayName = "Turn The Keys", helpText = "Turn the left key with !{0} turn left. Turn the right key with !{0} turn right.", moduleScore = 15 };

        //Kaneb
        ModComponentSolverInformation["TwoBits"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "TwoBits", moduleDisplayName = "Two Bits", helpText = "Query the answer with !{0} press K T query. Submit the answer with !{0} press G Z submit.", moduleScore = 8};
        ...
        ModComponentSolverInformation["EnglishTest"] = new ModuleInformation {builtIntoTwitchPlays = true, moduleID = "EnglishTest", moduleDisplayName = "English Test", moduleScore = 4, helpText = "Answer the displayed question with !{0} their (Match the answer exactly including any spaces. Case insensitive)"};
        ...
        ModComponentSolverInformation["WireSetComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "WireSetComponentSolver", moduleDisplayName = "Simple Wires", helpText = "!{0} cut 3 [cut wire 3] | Wires are ordered from top to bottom | Empty spaces are not counted", moduleScore = 1};
        ModComponentSolverInformation["ButtonComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "ButtonComponentSolver", moduleDisplayName = "Big Button", helpText = "!{0} tap [tap the button] | !{0} hold [hold the button] | !{0} release 7 [release when the digit shows 7]", moduleScore = 1};
        ModComponentSolverInformation["WireSequenceComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "WireSequenceComponentSolver", moduleDisplayName = "Wire Sequence", helpText = "!{0} cut 7 [cut wire 7] | !{0} down, !{0} d [next stage] | !{0} up, !{0} u [previous stage] | !{0} cut 7 8 9 d [cut multiple wires and continue] | Use the numbers shown on the module", manualCode = "Wire Sequences", moduleScore = 4};
        ModComponentSolverInformation["WhosOnFirstComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "WhosOnFirstComponentSolver", moduleDisplayName = "Who's on First", helpText = "!{0} what? [press the button that says \"WHAT?\"] | The phrase must match exactly | Not case sensitive", manualCode = "Who%E2%80%99s on First", moduleScore = 4};
        ...
        ModComponentSolverInformation["PasswordComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "PasswordComponentSolver", moduleDisplayName = "Password", helpText = "!{0} cycle 3 [cycle through the letters in column 3] | !{0} world [try to submit a word]", manualCode = "Passwords", moduleScore = 2};
        ModComponentSolverInformation["NeedyVentComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "NeedyVentComponentSolver", moduleDisplayName = "Needy Vent Gas", helpText = "!{0} yes, !{0} y [answer yes] | !{0} no, !{0} n [answer no]" };
        ModComponentSolverInformation["NeedyKnobComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "NeedyKnobComponentSolver", moduleDisplayName = "Needy Knob", helpText = "!{0} rotate 3, !{0} turn 3 [rotate the knob 3 quarter-turns]", manualCode = "Knobs" };
        ModComponentSolverInformation["NeedyDischargeComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "NeedyDischargeComponentSolver", moduleDisplayName = "Needy Capacitor", helpText = "!{0} hold 7 [hold the lever for 7 seconds]", manualCode = "Capacitor Discharge" };
        ModComponentSolverInformation["MorseCodeComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "MorseCodeComponentSolver", moduleDisplayName = "Morse Code", helpText = "!{0} transmit 3.573, !{0} trans 573, !{0} tx 573 [transmit frequency 3.573]", moduleScore = 3};
        ModComponentSolverInformation["MemoryComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "MemoryComponentSolver", moduleDisplayName = "Memory", helpText = "!{0} position 2, !{0} pos 2, !{0} p 2 [2nd position] | !{0} label 3, !{0} lab 3, !{0} l 3 [label 3]", moduleScore = 4};
        ModComponentSolverInformation["KeypadComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "KeypadComponentSolver", moduleDisplayName = "Keypad", helpText = "!{0} press 3 1 2 4 | The buttons are 1=TL, 2=TR, 3=BL, 4=BR", manualCode = "Keypads", moduleScore = 1};
        ModComponentSolverInformation["InvisibleWallsComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleID = "InvisibleWallsComponentSolver", moduleDisplayName = "Maze", helpText = "!{0} move up down left right, !{0} move udlr [make a series of white icon moves]", manualCode = "Mazes", moduleScore = 2};
        ...
        ModComponentSolverInformation["CheapCheckoutModule"] = new ModuleInformation { moduleScore = 12, helpText = "Cycle the items with !{0} items. Get customers to pay the correct amount with !{0} submit.  Return the proper change with !{0} submit 3.24."};
        ModComponentSolverInformation["ChessModule"] = new ModuleInformation { moduleScore = 9, helpText = "Cycle the positions with !{0} cycle.  Submit the safe spot with !{0} press C2."};
        ModComponentSolverInformation["ColourFlash"] = new ModuleInformation { moduleScore = 6, helpText = "Submit the correct response with !{0} press yes 3, or !{0} press no 5.", manualCode = "Color Flash" };
        ...
        ModComponentSolverInformation["CreationModule"] = new ModuleInformation { moduleScore = 12, helpText = "Combine two elements with !{0} combine water fire."};
        ...
        ModComponentSolverInformation["FriendshipModule"] = new ModuleInformation { moduleScore = 9, helpText = "Submit the desired friendship element with !{0} submit Fairness Conscientiousness Kindness Authenticity."};
        ModComponentSolverInformation["GridlockModule"] = new ModuleInformation {moduleScore = 12};
        ModComponentSolverInformation["HexamazeModule"] = new ModuleInformation { moduleScore = 12, helpText = "Move towards the exit with !{0} move 12 10 6 6 6 2, or with !{0} move N NW S S S NE.  (clockface or cardinal)"};
        ...
        ModComponentSolverInformation["spwizPerspectivePegs"] = new ModuleInformation { moduleScore = 5, helpText = ""};
        ModComponentSolverInformation["PianoKeys"] = new ModuleInformation { moduleScore = 6, helpText = "Submit your answer with !{0} press Bb Bb Bb Bb Gb Ab Bb Ab Bb."};
        ModComponentSolverInformation["PointOfOrderModule"] = new ModuleInformation {moduleScore = 7};
        ...
        ModComponentSolverInformation["Semaphore"] = new ModuleInformation { moduleScore = 7, helpText = "Move to the next flag with !{0} move right or !{0} press right. Move to previous flag with !{0} move left or !{0} press left.  Submit with !{0} press ok."};
        ModComponentSolverInformation["SillySlots"] = new ModuleInformation { moduleScore = 15, helpText = "Keep the slots with !{0} keep.  Pull the slots with !{0} pull."};
        ModComponentSolverInformation["SimonScreamsModule"] = new ModuleInformation { moduleScore = 12, helpText = "Press the correct colors for each round with !{0} press B O Y."};
        ...
        ModComponentSolverInformation["TextField"] = new ModuleInformation { moduleScore = 6, helpText = "Press the button in Row 2 column 3 and Row 3 Column 4 with !{0} press 3,2 4,3."};
        ...
        ModComponentSolverInformation["ZooModule"] = new ModuleInformation {moduleScore = 9};
