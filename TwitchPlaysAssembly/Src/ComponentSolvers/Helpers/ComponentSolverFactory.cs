...
public static class ComponentSolverFactory
{
	...
	static ComponentSolverFactory()
	{
		...
		//All of these modules are built into Twitch plays.
			...
			{ "MotionSense", new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Motion Sense" } },
			...
			{ "doomsdayButton", new ModuleInformation { statusLightPosition = StatusLightPosition.BottomLeft } },
