...
public static class ComponentSolverFactory
{
	...
	static ComponentSolverFactory()
	{
		...
		ModComponentSolverInformation["MotionSense"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Motion Sense", CameraPinningAlwaysAllowed = true };
		...
		//Kaneb
		ModComponentSolverInformation["TwoBits"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Two Bits", moduleScore = 7 };

		//Mock Army
		ModComponentSolverInformation["AnagramsModule"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Anagrams", moduleScore = 2 };
		...
		ModComponentSolverInformation["Needy Math"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Needy Math", manualCode = "Math", CameraPinningAlwaysAllowed = true, moduleScore = 0.7f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["WordScrambleModule"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Word Scramble", moduleScore = 2 };
		...
		ModComponentSolverInformation["EdgeworkModule"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Edgework", CameraPinningAlwaysAllowed = true, moduleScore = 1f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["NeedyBeer"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Needy Beer Refill Mod", CameraPinningAlwaysAllowed = true, moduleScore = 0.2f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["necronomicon"] = new ModuleInformation { moduleScore = 13, builtIntoTwitchPlays = true };
		...
		ModComponentSolverInformation["NeedyVentComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Needy Vent Gas", moduleScore = 0.2f, scoreMethod = ScoreMethod.NeedySolves, CameraPinningAlwaysAllowed = true };
		ModComponentSolverInformation["NeedyKnobComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Needy Knob", moduleScore = 0.4f, scoreMethod = ScoreMethod.NeedySolves, CameraPinningAlwaysAllowed = true };
		ModComponentSolverInformation["NeedyDischargeComponentSolver"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Needy Capacitor", moduleScore = 0.01f, scoreMethod = ScoreMethod.NeedyTime, CameraPinningAlwaysAllowed = true };
		...
		ModComponentSolverInformation["VentGasTranslated"] = new ModuleInformation { builtIntoTwitchPlays = true, moduleDisplayName = "Needy Vent Gas Translated", CameraPinningAlwaysAllowed = true, moduleScore = 0.25f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["characterShift"] = new ModuleInformation { moduleScore = 9, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["equations"] = new ModuleInformation { moduleScore = 11, DoesTheRightThing = true };
		ModComponentSolverInformation["insanagrams"] = new ModuleInformation { moduleScore = 5, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["LightsOut"] = new ModuleInformation { helpText = "Press the buttons with !{0} press 1 2 3. Buttons ordered from top to bottom, then left to right.", CameraPinningAlwaysAllowed = true, moduleScore = 0.90f, scoreMethod = ScoreMethod.NeedySolves };
		...
		//CaitSith2
		ModComponentSolverInformation["BigCircle"] = new ModuleInformation { moduleScore = 9, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["monsplodeWho"] = new ModuleInformation { DoesTheRightThing = true, helpText = "Press either button with “!{ 0 } press left / right | Left and Right can be abbreviated to(L) & (R)", moduleScore = 0.02f, scoreMethod = ScoreMethod.NeedyTime };
		...
		ModComponentSolverInformation["Mastermind Simple"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };
		ModComponentSolverInformation["Mastermind Cruel"] = new ModuleInformation { moduleScore = 15, DoesTheRightThing = true };

		//EpicToast
		ModComponentSolverInformation["brushStrokes"] = new ModuleInformation { moduleScore = 5, DoesTheRightThing = false };
		...
		ModComponentSolverInformation["cookieJars"] = new ModuleInformation { moduleScoreIsDynamic = true, moduleScore = 0, DoesTheRightThing = true, CameraPinningAlwaysAllowed = true };
		ModComponentSolverInformation["factoryMaze"] = new ModuleInformation { moduleScore = 19, DoesTheRightThing = true };
		ModComponentSolverInformation["instructions"] = new ModuleInformation { moduleScore = 6, DoesTheRightThing = true };
		ModComponentSolverInformation["krazyTalk"] = new ModuleInformation { moduleScore = 14, DoesTheRightThing = false };
		...
		ModComponentSolverInformation["faultyDigitalRootModule"] = new ModuleInformation { moduleScore = 6, DoesTheRightThing = true };
		ModComponentSolverInformation["FlavorText"] = new ModuleInformation { moduleScore = 2, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["sync125_3"] = new ModuleInformation { moduleScore = 5, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["Laundry"] = new ModuleInformation { moduleScore = 13, helpText = "Set all of the options with !{0} set all 30C,2 dot,110C,Wet Cleaning. Set just washing with !{0} set wash 40C. Submit with !{0} insert coin. ...pray for that 4 in 2 & lit BOB Kappa", DoesTheRightThing = true };
		...
		//GHXX
		ModComponentSolverInformation["characterCodes"] = new ModuleInformation { moduleScore = 5, DoesTheRightThing = true };
		ModComponentSolverInformation["thedealmaker"] = new ModuleInformation { moduleScore = 7, DoesTheRightThing = true };

		//Goofy
		ModComponentSolverInformation["harmonySequence"] = new ModuleInformation { moduleScore = 7, DoesTheRightThing = true };
		ModComponentSolverInformation["leftandRight"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };
		ModComponentSolverInformation["megaMan2"] = new ModuleInformation { moduleScore = 7, DoesTheRightThing = false };
		ModComponentSolverInformation["melodySequencer"] = new ModuleInformation { moduleScore = 10, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["rubiksClock"] = new ModuleInformation { manualCode = "Rubik%E2%80%99s Clock", moduleScore = 14, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["PasswordV2"] = new ModuleInformation { DoesTheRightThing = true, moduleDisplayName = "Safety Safe", moduleScore = 13 };
		...
		ModComponentSolverInformation["NeedyVentV2"] = new ModuleInformation { DoesTheRightThing = true, moduleDisplayName = "Needy Answering Questions", CameraPinningAlwaysAllowed = true, moduleScore = 0.4f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["NeedyKnobV2"] = new ModuleInformation { DoesTheRightThing = true, moduleDisplayName = "Needy Rotary Phone", CameraPinningAlwaysAllowed = true, moduleScore = 0.75f, scoreMethod = ScoreMethod.NeedySolves };
		...
		//Kritzy
		ModComponentSolverInformation["KritBlackjack"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };
		ModComponentSolverInformation["KritConnectionDev"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };
		ModComponentSolverInformation["KritCMDPrompt"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.5f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["KritFlipTheCoin"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.55f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["lgndColorMatch"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.25f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["lgndSnap"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.35f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["lgndTerrariaQuiz"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.4f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["unfairCipher"] = new ModuleInformation { moduleScore = 18, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["HotPotato"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true };
		...
		ModComponentSolverInformation["algebra"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["stockMarket"] = new ModuleInformation { moduleScore = 14, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["EncryptedValuesModule"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 1f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["http"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.6f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["QRCode"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.75f, scoreMethod = ScoreMethod.NeedySolves };
		...
		//Spare Wizard
		ModComponentSolverInformation["spwiz3DMaze"] = new ModuleInformation { DoesTheRightThing = true, moduleScore = 15, helpTextOverride = true, helpText = "!4 move L F R F U [move] | !4 walk L F R F U [walk slower] [L = left, R = right, F = forward, U = u-turn]" };
		...
		ModComponentSolverInformation["spwizTetris"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 1.1f, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["deckOfManyThings"] = new ModuleInformation { moduleScore = 9, DoesTheRightThing = true };
		ModComponentSolverInformation["doubleExpert"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };
		ModComponentSolverInformation["forgetThemAll"] = new ModuleInformation { moduleScore = 0, moduleScoreIsDynamic = true, CameraPinningAlwaysAllowed = true, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["graphicMemory"] = new ModuleInformation { moduleScore = 10, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["TheBulbModule"] = new ModuleInformation { moduleScore = 6, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["DiscoloredSquaresModule"] = new ModuleInformation { moduleScore = 9, DoesTheRightThing = true };
		ModComponentSolverInformation["DividedSquaresModule"] = new ModuleInformation { moduleScore = 6, DoesTheRightThing = true };
		ModComponentSolverInformation["DoubleOhModule"] = new ModuleInformation { moduleScore = 7, DoesTheRightThing = true, statusLightOverride = true, statusLightDown = false, statusLightLeft = false };
		...
		ModComponentSolverInformation["MouseInTheMaze"] = new ModuleInformation { moduleScore = 11, DoesTheRightThing = true };
		...
		//ZekNikZ
		ModComponentSolverInformation["booleanVennModule"] = new ModuleInformation { moduleScore = 8, helpText = "Select parts of the diagram with !{0} a bc abc. Options are A, AB, ABC, AC, B, BC, C, O (none).", DoesTheRightThing = true };
		...
		ModComponentSolverInformation["symbolicPasswordModule"] = new ModuleInformation { moduleScore = 7, helpText = "Cycle a row with cycle t l. Cycle a column with cycle m. Submit with !{0} submit. Rows are TL/TR/BL/BR, columns are L/R/M. Spaces are important!", DoesTheRightThing = true };
		ModComponentSolverInformation["VaricoloredSquaresModule"] = new ModuleInformation { moduleScore = 8, DoesTheRightThing = true };

		//Other modded Modules not built into Twitch Plays
		ModComponentSolverInformation["aa"] = new ModuleInformation { DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, moduleScore = 0.4f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["BartendingModule"] = new ModuleInformation { moduleScore = 7, DoesTheRightThing = true };
		...
		ModComponentSolverInformation["buttonMasherNeedy"] = new ModuleInformation { moduleScore = 0.25f, moduleDisplayName = "Needy Button Masher", helpText = "Press the button 20 times with !{0} press 20", DoesTheRightThing = true, CameraPinningAlwaysAllowed = true, scoreMethod = ScoreMethod.NeedySolves };
		...
		ModComponentSolverInformation["EternitySDec"] = new ModuleInformation { DoesTheRightThing = false, CameraPinningAlwaysAllowed = true, moduleScore = 0.6f, scoreMethod = ScoreMethod.NeedySolves };
		ModComponentSolverInformation["groceryStore"] = new ModuleInformation { moduleScore = 7, DoesTheRightThing = true, helpText = "Use !{0} add item to cart | Adds an item to the cart. Use !{0} pay and leave | Pays and leaves | Commands can be abbreviated with !{0} add & !{0} pay" };
		...
		ModComponentSolverInformation["vigenereCipher"] = new ModuleInformation { moduleScore = 5, DoesTheRightThing = true };
