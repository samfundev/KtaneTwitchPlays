...
public static class ComponentSolverFactory
{
	...
	static ComponentSolverFactory()
	{
		...
		ModComponentSolverInformation["USA"] = new ModuleInformation { moduleScore = 3 };
		...
		ModComponentSolverInformation["screw"] = new ModuleInformation { moduleScore = 9, helpText = "Unscrew with !{0} unscrew. Screw with !{0} screw tr or !{0} screw 3. Options are TL, TM, TR, BL, BM, BR. Press a button with !{0} press b or !{0} press 2." };
