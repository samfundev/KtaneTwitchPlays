...
public static class ComponentSolverFactory
{
	...
	static ComponentSolverFactory()
	{
		...
		ModComponentSolverInformation["CoordinateSystemsModule"] = new ModuleInformation { moduleScore = 15, helpText = "Cycle the options with !{0} cycle. Submit your answer with !{0} submit <3,2>. Partial answers are acceptable. To do chinese numbers, its !{0} submit chinese 12.", DoesTheRightThing = false };
